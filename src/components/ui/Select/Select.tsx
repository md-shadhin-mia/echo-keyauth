...
>(
    ...
    // theme`colors` returns an object with all the color values from the theme
    // For example, it would contain `primary`, `secondary`, `success`, `error`, etc.
    // Each color value is an object with multiple shades, e.g. `primary` would have
    // `primary.100`, `primary.200`, `primary.300`, etc.
    const twColor: Record<string, Record<string, string>> = theme`colors`

    // theme`height` returns an object with some pre-defined height values
    // For example, it would contain `auto`, `full`, `screen`, `1/2`, `1/3`, etc.
    const twHeight: Record<string, string> = theme`height`
